...
class DataSetControlWaistHeight:

    def __init__(self):
        self._angles = tuple(range(0, 360, 10))
        self._distances = tuple(range(60, 400, 10))
    ...
    def save_predicted(
        ...
        directory_local_path = f"data/waist_height_predicted/{target_directory_name}"
    ...
    def load_predicted(
        ...
        file_name = f"data/waist_height_predicted/{target_directory_name}/{distance}cm_{angle}_deg_predicted.txt"
    ...
    def get_frames(self, distance, angle):
        ...
        left_file_name = f"data/waist_height/{distance}cm_{angle}_deg_left.png"
        left_frame = cv2.imread(left_file_name)

        right_file_name = (
            f"data/waist_height/{distance}cm_{angle}_deg_right.png"
        )
    ...
    def get_true_points(self, distance, angle):
        file = f"data/waist_height/{distance}cm_{angle}_deg_points.txt"
