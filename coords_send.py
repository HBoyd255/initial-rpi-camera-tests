...
if __name__ == "__main__":
    ...
    left_process = Process(target=capture_hand, args=("left", left_queue))
    right_process = Process(target=capture_hand, args=("right", right_queue))
    display_process = Process(target=show)
